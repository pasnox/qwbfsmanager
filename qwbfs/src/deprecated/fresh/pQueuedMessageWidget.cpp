	...
	: QWidget( parent )
{
	...
	lPixmap->setSizePolicy( QSizePolicy( QSizePolicy::Maximum, QSizePolicy::Maximum ) );
	// message
	...
	dbbButtons->setSizePolicy( QSizePolicy( QSizePolicy::Maximum, QSizePolicy::Maximum ) );
	// layout
...
void pQueuedMessageWidget::showMessage()
{
	...
	lMessage->setWordWrap( !Qt::mightBeRichText( msg.Message ) );
	// set buttons
